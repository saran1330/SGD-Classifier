...
2.Split the data into training and testing sets and apply scaling.
3.Train the model using SGD Classifier.
4.Predict the species and evaluate the model accuracy.
## Program:
```
/*
...
## Output:
<img width="1382" height="510" alt="image" src="https://github.com/user-attachments/assets/2b6b7aae-d1a0-499f-8b7e-42f62b41b3aa" />
